...
public class Grid {
    ...
    public void ohrmLogin() throws InterruptedException, MalformedURLException {
        ...
        WebDriver driver = new RemoteWebDriver(new URL("http://192.168.1.13:1217"), caps);
      ...
      //Call getScreenshotAs method to create image file
   	 	...
   	 	FileHandler.copy(src, new File("C:\\Users\\LavanyaJyothi\\OneDrive - Hallmark Health Care Solutions, Inc\\Desktop\\Selenium Web\\screenshots.jpg"));
        }
